...
![Main screen — login / entry](images/ui-main.png)

### Senior (tasks and routines)

![Senior screen — daily & weekly checklist](images/ui-senior.png)

### Caregiver (menu or caregiver login)

![Caregiver screen — menu after sign-in](images/ui-caregiver.png)
...
| Document | Contents |
|----------|----------|
| [PRD.md](PRD.md) | Product goals, users, functional requirements |
| [SDD.md](SDD.md) | Software design: layers, components, behaviour |
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture diagram and storage overview |
| [SEQUENCE_DIAGRAMS.md](SEQUENCE_DIAGRAMS.md) | Step-by-step flows between UI, services, and storage |
| [API.md](API.md) | Implementation notes: packages, `Storage`, controllers (no HTTP API) |
| [TEAM_GIT_WORKFLOW_SourceTree.md](TEAM_GIT_WORKFLOW_SourceTree.md) | Git / SourceTree workflow for contributors |

Editable diagram sources (draw.io): `images/*.drawio`. Exported images: `images/`, `architecture/`.
